...
Delay in seconds after generation. Useful to reduce CUDA / memory pressure between runs.
...
Internal generated job name, for example:
...
The job_id is only the generated folder/name, while model_path is the actual 3D file path.
